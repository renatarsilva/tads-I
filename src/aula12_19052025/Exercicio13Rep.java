...
public class Exercicio13Rep {
    public static void main(String[] args) {
        ...
        // entrada de dados
        System.out.println("Quantos times seṛo?");
        qtdTime = sc.nextInt();
        System.out.println("Quantos jogadores seṛo?");
        qtdJog = sc.nextInt();
        // criar os arrays
        ...
        for (int time = 0; time < qtdTime; time++) {
            ...
            System.out.printf("M̩dia de idade do time %d ̩ %d%n", time + 1, mediaIdade);
        }
        mediaAltura = mediaAltura / (qtdTime * qtdJog);
        System.out.printf("M̩dia de altura do campeonato: %.2f%n", mediaAltura);
